...
public class SimdTest : BaseDisarmTest
{
    ...
    public void TestScalarAdvancedSimdShiftByImmediate()
    {
        ...
        Assert.Equal("0x00000000 SQSHLU H6, H9, 0x8", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x7F206526, Arm64Mnemonic.SQSHLU);
        Assert.Equal("0x00000000 SQSHLU S6, S9, 0x18", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x7F406526, Arm64Mnemonic.SQSHLU);
        Assert.Equal("0x00000000 SQSHLU D6, D9, 0x30", inst.ToString());
        ...
        Assert.Equal("0x00000000 UQSHL H15, H19, 0x8", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x7F20766F, Arm64Mnemonic.UQSHL);
        Assert.Equal("0x00000000 UQSHL S15, S19, 0x18", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x7F40766F, Arm64Mnemonic.UQSHL);
        Assert.Equal("0x00000000 UQSHL D15, D19, 0x30", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x7F10867C, Arm64Mnemonic.SQSHRUN);
        Assert.Equal("0x00000000 SQSHRUN H28, S19, 0x0", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x7F20867C, Arm64Mnemonic.SQSHRUN);
        Assert.Equal("0x00000000 SQSHRUN S28, D19, 0xFFFFFFFFFFFFFFF0", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x7F108C56, Arm64Mnemonic.SQRSHRUN);
        Assert.Equal("0x00000000 SQRSHRUN H22, S2, 0x0", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x7F208C56, Arm64Mnemonic.SQRSHRUN);
        Assert.Equal("0x00000000 SQRSHRUN S22, D2, 0xFFFFFFFFFFFFFFF0", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x7F109429, Arm64Mnemonic.UQSHRN);
        Assert.Equal("0x00000000 UQSHRN H9, S1, 0x0", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x7F209429, Arm64Mnemonic.UQSHRN);
        Assert.Equal("0x00000000 UQSHRN S9, D1, 0xFFFFFFFFFFFFFFF0", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x7F109DEE, Arm64Mnemonic.UQRSHRN);
        Assert.Equal("0x00000000 UQRSHRN H14, S15, 0x0", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x7F209DEE, Arm64Mnemonic.UQRSHRN);
        Assert.Equal("0x00000000 UQRSHRN S14, D15, 0xFFFFFFFFFFFFFFF0", inst.ToString());
        ...
        Assert.Equal("0x00000000 SQSHL H8, H19, 0x8", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x5F207668, Arm64Mnemonic.SQSHL);
        Assert.Equal("0x00000000 SQSHL S8, S19, 0x18", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x5F407668, Arm64Mnemonic.SQSHL);
        Assert.Equal("0x00000000 SQSHL D8, D19, 0x30", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x5F1095A0, Arm64Mnemonic.SQSHRN);
        Assert.Equal("0x00000000 SQSHRN H0, S13, 0x0", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x5F2095A0, Arm64Mnemonic.SQSHRN);
        Assert.Equal("0x00000000 SQSHRN S0, D13, 0xFFFFFFFFFFFFFFF0", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x5F109F2B, Arm64Mnemonic.SQRSHRN);
        Assert.Equal("0x00000000 SQRSHRN H11, S25, 0x0", inst.ToString());
        inst = DisassembleAndCheckMnemonic(0x5F209F2B, Arm64Mnemonic.SQRSHRN);
        Assert.Equal("0x00000000 SQRSHRN S11, D25, 0xFFFFFFFFFFFFFFF0", inst.ToString());
